...
public class ObjectManager {
    ...
    public void loadObjects(Level newLevel) {
        potions = new ArrayList<Potion>(newLevel.getPotions());
        containers = new ArrayList<GameContainer>(newLevel.getContainers());
        spikes = newLevel.getSpikes();
        cannons = new ArrayList<Cannon>(newLevel.getCannons());
        projectiles.clear();
    }
